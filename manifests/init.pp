...
class kubernetes (
  ...
  String $cni_pod_cidr                                             = $kubernetes::params::cni_pod_cidr,
  Boolean $cni_pod_cidr_allocate                                   = $kubernetes::params::cni_pod_cidr_allocate,
  Integer[1, 32] $cni_pod_cidr_mask                                = $kubernetes::params::cni_pod_cidr_mask,
  Stdlib::Ip_address $controller_manager_address                   = $kubernetes::params::controller_manager_address,
  Stdlib::Ip_address $scheduler_address                            = $kubernetes::params::scheduler_address,
